...
CREATE TABLE whois_record (
  ...
  registrant_phone              VARCHAR(15),
  admin_phone                   VARCHAR(15),
  tech_phone                    VARCHAR(15),
  realregistrant_phone          VARCHAR(15),
  realadmin_phone               VARCHAR(15),
  realtech_phone                VARCHAR(15),

  registrant_fax                VARCHAR(15),
  admin_fax                     VARCHAR(15),
  tech_fax                      VARCHAR(15),
  realregistrant_fax            VARCHAR(15),
  realadmin_fax                 VARCHAR(15),
  realtech_fax                  VARCHAR(15),
